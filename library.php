...
function footer_web()
	  ...
	  ?>
	  <center>
&copy; Copyright 2016 All Right Reserved <br />
 Marisha Ayuardini
       </center>
	  <?php
	  }
function navigator_web()
	  {
              ...
              <li><a href="index.php?page=11&current11=current"  class="<?php echo $current11;?>" ><img src="images/menu/blue_circle - print preview.png" width="24" height="24" align="absmiddle" border=0px /> KAMUS</a></li>
			    <?php
...
<li><a href="pakar_index.php?page=11&current11=current"  class="<?php echo $current3;?>" ><img src="images/menu/blue_circle - print preview.png" width="24" height="24" align="absmiddle"border=0px/> KAMUS</a></li>
			  <?php
...
<li><a href="user_index.php?page=7&current7=current&act=identifikasi&induk=&u=<?php echo $_SESSION['SESS_USERNAME']; ?>" class="<?php echo $current7;?>"><img src="images/menu/blue_circle - loop.png" width="24" height="24" align="absmiddle"/> identifikasi</a></li>
<li><a href="user_index.php?page=8&current8=current&act=0&u=<?php echo $_SESSION['SESS_USERNAME']; ?>" class="<?php echo $current8;?>"><img src="images/menu/blue_circle - stats.png" width="24" height="24" align="absmiddle"/> Hasil identifikasi</a></li>
<li><a href="user_index.php?page=11&current11=current&act=0&u=<?php echo $_SESSION['SESS_USERNAME']; ?>" class="<?php echo $current11;?>"><img src="images/menu/blue_circle - stats.png" width="24" height="24" align="absmiddle"/> KAMUS</a></li>
...
<ul id="menu-kiri" class="topmenu">
	...
	<li class="topmenu"><a href="pakar_index.php?page=4&current4=current&act=tampilgolongan" class="<?php echo $current4;?>">Daftar Jenis golongan<img src="images/menu/blue_circle - document text.png" alt="Tipe Diabetes Melitus" width="24" height="24" align="absmiddle"/></a></li>
	<li class="topmenu"><a href="pakar_index.php?page=5&current5=current&act=tampilciri"  class="<?php echo $current5;?>">Daftar ciri<img src="images/menu/blue_circle - my documents.png" alt="Daftar ciri" width="24" height="24" align="absmiddle"/></a></li>
	...
	<li class="topmenu"><a href="pakar_index.php?page=8&current=current&act=0"  class="<?php echo $current;?>">Bobot ciri<img src="images/menu/blue_circle - percent.png" alt="Bobot ciri" width="24" height="24" align="absmiddle"/></a></li>
...
function menu_user()
	  {
			  ...
			  <li><a href="user_index.php?page=7&current7=current&act=identifikasi&induk=&u=<?php echo $_SESSION['SESS_USERNAME']; ?>"  class="<?php echo $current7;?>"><img src="images/langmanager.png" width="25" height="25" align="absmiddle"border=0px/>  identifikasi</a></li>
			  <li><a href="user_index.php?page=8&current8=current&act=0&u=<?php echo $_SESSION['SESS_USERNAME']; ?>"  class="<?php echo $current8;?>"><img src="images/query.png" width="25" height="25" align="absmiddle"border=0px/>  Lihat Hasil identifikasi </a></li>
...
function form_login()
	  {
		...
		<div class="subtitle">
		  <div align="left"><img src="images/lock-24.png" width="24" height="24"  align="absmiddle"/> Login</div>
		</div>
...
#fungsi untuk membuat kode otomatis untuk golongan
function kdautogolongan($tabel, $inisial){
...
#fungsi untuk membuat kode otomatis untuk ciri
function kdautociri($tabel, $inisial){
	$struktur	= mysql_query("SELECT * FROM $tabel");
	$field		= mysql_field_name($struktur, 0);
	$panjang	= mysql_field_len($struktur, 0);
